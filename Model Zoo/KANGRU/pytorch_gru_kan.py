...
class KANGRU(Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Set logger.
        self.logger = get_module_logger("KANGRU")
        self.logger.info("KANGRU pytorch version...")
    ...
    def train_epoch(self, data_loader):
        ...
        for _, (data, weight) in enumerate(tqdm(data_loader, mininterval=2)):
...
# class KANGRUModel(nn.Module):
#     def __init__(self, input_dim, hidden_dim, num_layers, output_dim):
#         super(KANGRUModel, self).__init__()
...
class KANGRUModel(nn.Module):
    def __init__(self, d_feat=6, hidden_size=64, num_layers=2, dropout=0.0):
        ...
        self.e_kan = KAN([hidden_size,  1])

        self.d_feat = d_feat

    def forward(self, x):
        out, _ = self.rnn(x)
        return self.e_kan(out[:, -1, :]).squeeze()
