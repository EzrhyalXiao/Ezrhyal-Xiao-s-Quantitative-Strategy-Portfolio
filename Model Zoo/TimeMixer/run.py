...
if __name__ == '__main__':
    ...
    # config_path = 'workflow_config_patchtst_Alpha158.yaml'
    config_path = 'workflow_config_timemixer_Alpha360.yaml'
    # config_path = 'workflow_config_patchtst_Alpha360.yaml'
    # config_path = 'workflow_config_dlinear_Alpha360.yaml'
    # config_path = 'workflow_config_autoformer_Alpha360.yaml'
    workflow(config_path)

    # for iconfig_path in ['workflow_config_autoformer_Alpha360.yaml', 'workflow_config_informer_Alpha360.yaml']:
    #     workflow(iconfig_path)
